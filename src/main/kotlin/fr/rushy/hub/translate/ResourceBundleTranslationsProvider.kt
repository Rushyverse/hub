 ...
 */
fun ResourceBundleTranslationsProvider.registerResourceBundleForSupportedLocales(
    bundleName: String,
 ...
 */
open class ResourceBundleTranslationsProvider : TranslationsProvider() {
