...
class LangMenu(private val translationsProvider: TranslationsProvider, private val locale: Locale, val player: Player) :
    ...
    override suspend fun build(): Inventory {
        ...
        inv.setItemStack(0, createFrenchItem())
        inv.setItemStack(1, createEnglishItem())
        inv.setItemStack(2, createSpanishItem())
    ...
    private fun buildLangItem(language: String, lore: String, skin: PlayerSkin): ItemStack {
